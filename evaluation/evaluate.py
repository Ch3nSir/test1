...
from openrlhf.models.modeling_unirag import UniRAG
...
class ResultCalculator:
    ...
    def calculate_basic_metrics(self, result_list: List[Dict]) -> Dict[str, float]:
        ...
        for result in result_list:
            prediction = result['UniRAG_normal_output']
    ...
    def visualize_mse(self, result_list: List[Dict], save_path: str) -> Dict[str, Any]:
        ...
        for result in result_list:
            mem_rep = result['UniRAG_compressed_output']
            non_mem_rep = result['UniRAG_normal_output']
...
class AcceleratedUniRAGInference:
    ...
    def __init__(self, model_path: str, training_stage: str = None, 
        ...
        if self.accelerator.is_main_process:
            ...
            print("Loading UniRAG model...")
        
        # Load model
        self.model = UniRAG.from_pretrained(
            model_path, 
...
def main():
    parser = argparse.ArgumentParser(description="UniRAG Model Inference")
    ...
    for dataset in datasets_list:
        ...
        inference_engine = AcceleratedUniRAGInference(
        ...
        with inference_engine.accelerator.split_between_processes(processed_data, apply_padding=False) as local_data:
            ...
            for batch_idx in tqdm(range(num_batches), 
                ...
                for i, (item, normal_out, compressed_out) in enumerate(zip(batch, batch_out_normal, batch_out_compressed)):
                    ...
                    result_item['UniRAG_normal_output'] = normal_out
                    result_item['UniRAG_compressed_output'] = compressed_out
